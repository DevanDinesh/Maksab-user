...
class AuthController extends GetxController implements GetxService {
  ...
  void saveUserNumberAndPasswordAndId(String number, String password, String countryCode,String userId) {
    authRepo.saveUserNumberAndPasswordAndId(number, password, countryCode,userId);
  }
