...
class Restaurant {
  ...
  List<CategoryIn> categoryInfo;
  CategoryIn categoryInc;
  int veg;
  int nonVeg;
  Discount discount;
  ...
  Restaurant.fromJson(Map<String, dynamic> json) {
    ...
    includeDelivery = json['include_delivery'];
    ...
    perKmShippingCharge = json['per_km_shipping_charge'] != null ? json['per_km_shipping_charge'].toDouble() : 0.0;
     minimumKm = json['minimum_km'] != null ? json['minimum_km'].toDouble() : 0.0;
    ...
    restaurantSubscription = json['restaurant_sub'] != null ? RestaurantSubscription.fromJson(json['restaurant_sub']) : null;
     if (json['category_info'] != null) {
      categoryInfo = <CategoryIn>[];
      json['category_info'].forEach((v) {
        categoryInfo.add(new CategoryIn.fromJson(v));
      });
    }
    categoryInc = json['category_inc'] != null
        ? new CategoryIn.fromJson(json['category_inc'])
        : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['include_delivery'] = this.includeDelivery;
...
class CategoryIn {
   ...
   CategoryIn.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];

    if( json['include_delivery']!=null){
  includeDelivery = json['include_delivery'];
      ...
      json['category_info'].forEach((v) {
        categoryIn.add(new CategoryIn.fromJson(v));
      });
    }
