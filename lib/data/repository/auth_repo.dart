...
class AuthRepo {
  ...
  // for  Remember Email
  Future<void> saveUserNumberAndPasswordAndId(String number, String password, String countryCode,String userId) async {
    try {
  ...
  void saveUserNumber(String userID) async {
    await sharedPreferences.setString(AppConstants.USER_Id,userID);
  }

  void saveUserId(String userID) {
     sharedPreferences.setString(AppConstants.USER_Id,userID) ;
  }
