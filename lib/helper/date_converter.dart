...
class DateConverter {
  ...
  static String formatTimeDifference(String deliveryTime, String orderTime, int processingTime, String scheduleAt) {
  int minutesDifference = differenceInMinute(deliveryTime, orderTime, processingTime, scheduleAt);
  ...
  if (minutesDifference < 5) {
    ...
    int days = minutesDifference ~/ 1440;
    int remainingHours = (minutesDifference % 1440) ~/ 60;
    int remainingMinutes = minutesDifference % 60;
    
    if (remainingHours > 0 && remainingMinutes > 0) {
      return '$days day $remainingHours hour $remainingMinutes minutes';
