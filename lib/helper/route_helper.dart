...
class RouteHelper {
  ...
  static String getOrderSuccessRoute(String orderID, String status, double amount, int is_saved) => '$orderSuccess?id=$orderID&status=$status&amount=$amount&is_saved=$is_saved';
  ...
  static List<GetPage> routes = [
    ...
    // ))),
    GetPage(name: orderSuccess, page: () => getRoute(OrderSuccessfulScreen(
      orderID: Get.parameters['id'], status: Get.parameters['status'].contains('success') ? 1 : 0, totalAmount: null, is_saved: Get.parameters['is_saved'].contains('is_saved') ? 1 : 0,
    ))),
