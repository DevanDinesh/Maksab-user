...
class AppConstants {
  static const String APP_NAME = 'MAKSAB';
  static const double APP_VERSION = 6.1;

  // static const String BASE_URL = 'https://maksab.om/staging/maksabom'; // test
  static const String BASE_URL ='https://test.maksab.om';
  
  // static const String BASE_URL = 'https://maksab.om'; // live
  ...
  static const String OFFLINE_WALLET_URL= '/api/v1/customer/wallet/offline';
  ...
  static const String GET_USER_INFO = '/api/v1/customer/get-user-info';
  static const String OFFLINE_WALLET= '/api/v1/customer/wallet/offline';
  ...
  static const String INCLUDE_DELIVERY = 'include_delivery';
