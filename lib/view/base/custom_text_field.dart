      ...
      children: [
        ...
        TextField(
          ...
          inputFormatters: widget.inputType == TextInputType.phone ? <TextInputFormatter>[FilteringTextInputFormatter.allow(RegExp('[0-9]'))]
              : widget.isAmount ? [FilteringTextInputFormatter.allow(RegExp(r'[0-9.]'))] : widget.isNumber ? [FilteringTextInputFormatter.allow(RegExp(r'[0-9]'))] :  [AlphabetInputFormatter()],
...
class AlphabetInputFormatter extends TextInputFormatter {
  ...
  TextEditingValue formatEditUpdate(
    ...
    final newValueText = newValue.text.replaceAll(RegExp(r'[٠-٩]'), '');
