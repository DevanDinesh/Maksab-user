...
class _ProductBottomSheetState extends State<ProductBottomSheet> {
          ...
          child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.end, children: [
            ...
            Padding(
              ...
              child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                (widget.product.prepareMinutesTime != null) ? Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    // Text('Prepare Time'.tr, style: robotoMedium),
                    // SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                    // Text(widget.product.description, style: robotoRegular),
                    // SizedBox(height: Dimensions.PADDING_SIZE_LARGE),
                    // Text('Minutes'.tr, style: robotoMedium),

                    Text.rich(
                      TextSpan(
                        text:'Prepare Time'.tr + " :",
                        style: robotoMedium,
                        children: <TextSpan>[
                          // TextSpan(
                          //   text: "${widget.product.prepareMinutesTime}",
                          //   style: robotoMedium.copyWith(fontWeight: FontWeight.bold , color: Colors.red),
                          // ),

                          TextSpan(
                            text: " " + buildTrTime(widget.product.prepareMinutesTime),
                            style: robotoMedium.copyWith(fontWeight: FontWeight.bold , color: Colors.red),
                          ),
                        ],
                      ),
  ...
  String buildTrTime(int minutes) {
    ...
    if (duration.inMinutes < 60) {
      ...
      return '${hours} ${'Hour'.tr} ${(remainingMinutes > 0) ? '$remainingMinutes ' + 'Minutes'.tr : ''}';
    } else {
      int days = duration.inDays;
      int remainingHours = duration.inHours.remainder(24);
      return '${days} ${'Day'.tr} ${(remainingHours > 0) ? '$remainingHours ${'Hour'.tr}' : ''}';
    }
  }
