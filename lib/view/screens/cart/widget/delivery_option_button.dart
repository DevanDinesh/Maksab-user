...
class DeliveryOptionButton extends StatelessWidget {
 ...
 final bool enabled;
  ...
  DeliveryOptionButton({@required this.value, @required this.title, @required this.charge, @required this.isFree, @required this.includeDelivery, @required this.image, @required this.index,this.enabled = true});
