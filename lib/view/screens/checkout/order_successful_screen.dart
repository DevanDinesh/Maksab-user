...
class OrderSuccessfulScreen extends StatefulWidget {
  ...
  OrderSuccessfulScreen({@required this.orderID, @required this.status, @required this.totalAmount, @required this.is_saved});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<OrderController>(builder: (orderController) {
        ...
        if (orderController.trackModel != null) {
           bool is_saved = orderController.trackModel.is_saved == 1;
          return Center(child: SizedBox(width: Dimensions.WEB_MAX_WIDTH, child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [

          Image.asset(success || is_saved ? Images.checked : Images.warning, width: 100, height: 100),
          ...
          // Text(
          //       is_saved
          //         ? 'you_saved_the_order_successfully'.tr 
          //         : success 
          ...
          Text(
                ...
                is_saved
                  ...
                  ? 'you_saved_the_order_successfully'.tr 
                  : (success ? 'you_placed_the_order_successfully' : 'your_order_is_failed_to_place').tr,
                style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeLarge),
              ),
              SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
          ...
          Padding(
            ...
            child: Text(
              is_saved
                  ? 'your_order_is_saved_successfully'.tr 
                  : success
