...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  void _initData() async {
    browser = MyInAppBrowser(orderID: widget.orderModel.id.toString(),
...
class MyInAppBrowser extends InAppBrowser {
  ...
  void _redirect(String url) {
    if(_canRedirect) {
      ...
      if (_isSuccess) {
        Get.offNamed(RouteHelper.getOrderSuccessRoute(orderID, 'success', orderAmount, is_saved));
      } else if (_isFailed || _isCancel) {
        Get.offNamed(RouteHelper.getOrderSuccessRoute(orderID, 'fail', orderAmount, is_saved));
      }
    }
  }
