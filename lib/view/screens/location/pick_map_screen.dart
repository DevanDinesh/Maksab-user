          ...
          return Stack(children: [
            ...
            Positioned(
              ...
              child: !locationController.isLoading ? CustomButton(
                ...
                onPressed: (locationController.buttonDisabled || locationController.loading) ? null : () async {
                  if(locationController.pickPosition.latitude != 0 && locationController.pickAddress.isNotEmpty)
                  {
                    // SharedPreferences prefs = await SharedPreferences.getInstance();
                    final prefs = await SharedPreferences.getInstance();
                    prefs.setDouble('lat', locationController.pickPosition.latitude);
                    prefs.setDouble('lng', locationController.pickPosition.longitude);
                    print("ddd ${locationController.pickPosition.latitude}");
                    print("ddd ${locationController.pickAddress.isNotEmpty}");
                    if(widget.fromAddAddress) {
