  ...
  Widget build(BuildContext context) {
    ...
    if (Get.find<SplashController>().configModel.toggleDmRegistration &&
      ...
      if (Platform.isAndroid) {
        urlde = "https://play.google.com/store/apps/details?id=om.thawani.deliveryman";
      } else if (Platform.isIOS) {
        urlde = "https://apps.apple.com/om/app/tauseel-maksab/id1668520169";
      }
    ...
    if (Get.find<SplashController>().configModel.toggleRestaurantRegistration &&
      ...
      var urlst = "" ;
      if (Platform.isAndroid) {
        urlst = "https://play.google.com/store/apps/details?id=om.thawani.stroe";
      } else if (Platform.isIOS) {
        urlst = "https://apps.apple.com/om/app/tager-maksab/id1668517999";
      }
