    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: GetBuilder<OrderController>(builder: (orderController) {
          ...
          double _total = _itemsPrice + _addOns - _discount + _tax + _charge - _couponDiscount + _dmTips;
                ...
                && _order.orderStatus != 'refund_request_canceled') ? Column(children: [
                  ...
                  Center(
                    child: Row(mainAxisSize: MainAxisSize.min, children: [
                      if(_order.restaurant!=null)
                      if(_order.restaurant.deliveryTime!=null)
                      Text(
            ...
            !orderController.showCancelled ? Center(
              child: SizedBox(
                ...
                child: Row(children: [
                  ...
                  || _order.orderStatus == 'processing' || _order.orderStatus == 'handover'|| _order.orderStatus == 'picked_up'||_order.orderStatus == 'saved' ) ? Expanded(
                    child: CustomButton(
                  ...
                  _order.orderStatus == 'pending' || _order.orderStatus == 'saved'? Expanded(child: Padding(
                    padding: EdgeInsets.all(Dimensions.PADDING_SIZE_SMALL),
                    child: TextButton(
