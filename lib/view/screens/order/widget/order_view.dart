                                      ...
                                      SizedBox(
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              GestureDetector(
                                                onTap: () {
                                                  // String invoiceDownloadUrl =   'https://test.maksab.om/api/v1/order/invoice/${orderList[index].id}';
                                                  String invoiceDownloadUrl =   'https://test.maksab.om/api/v1/order/invoice/${orderList[index].id}';
                                                  launchURL(invoiceDownloadUrl);
                                                },
                                                child: Container(
                                               ...
                                               children: [
                                                  ...
                                                  SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                                                  Text(
                                                    orderList[index].orderStatus == 'saved' ? 'Saved' : orderList[index].orderStatus.tr,
                                                    style: robotoMedium.copyWith(
                                                      fontSize: Dimensions.fontSizeExtraSmall,
                                                      color: Theme.of(context).primaryColor,
                                                    ),
