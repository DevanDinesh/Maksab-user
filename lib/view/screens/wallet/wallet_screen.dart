...
import 'widget/transfer_money_wallet_bottom_sheet.dart';
                                  ...
                                  child:  Row(mainAxisAlignment: widget.fromWallet ? MainAxisAlignment.start : MainAxisAlignment.center, children: [
                                    ...
                                    widget.fromWallet ? Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min,
                                      children: [
                                        ...
                                        Text('OMR'.tr,style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).cardColor)),
                                        SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                                        Text(
                                    ...
                                    SizedBox(width: Dimensions.PADDING_SIZE_OVER_LARGE),
                                    SizedBox(width: Dimensions.PADDING_SIZE_DEFAULT),

                                    IconButton(onPressed: (){
                                      ResponsiveHelper.isMobile(context) ? Get.bottomSheet(
                                          TransferMoneyWalletBottomSheet(fromWallet: widget.fromWallet)
                                      ) : Get.dialog(
                                        Dialog(child: TransferMoneyWalletBottomSheet(fromWallet: widget.fromWallet)),
                                      );
                                      // Navigator.push(context, MaterialPageRoute(builder: (context) =>
                                      //     ChargeWalletScreen(
                                      //       amount:"10" ,
